...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-nix/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-nix/actions/workflows/validate.yml)

Neovim tree-sitter queries for **nix**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-nix",
...
- [ ] Changes are scoped to `nix` — do not include files for other languages
